...
public class ImportStyleBookEntriesMVCActionCommand
	...
	protected void doProcessAction(
		...
		try {
			List<StyleBookEntryImporterResult> styleBookEntryImporterEntries =
			...
			for (StyleBookEntryImporterResult styleBookEntryImporterResult :
					styleBookEntryImporterEntries) {

				StyleBookEntry styleBookEntry =
					styleBookEntryImporterResult.getStyleBookEntry();

				if ((styleBookEntryImporterResult.getStatus() !=
	...
	private List<StyleBookEntryImporterResult> _importStyleBookEntries(
