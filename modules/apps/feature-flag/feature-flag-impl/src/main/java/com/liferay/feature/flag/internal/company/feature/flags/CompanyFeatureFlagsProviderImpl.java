...
package com.liferay.feature.flag.internal.company.feature.flags;
...
import com.liferay.feature.flag.manager.FeatureFlagPreferencesManager;
import com.liferay.feature.flag.model.DependencyAwareFeatureFlag;
import com.liferay.feature.flag.model.FeatureFlag;
import com.liferay.feature.flag.model.FeatureFlagImpl;
import com.liferay.feature.flag.model.LanguageAwareFeatureFlag;
import com.liferay.feature.flag.model.PreferenceAwareFeatureFlag;
...
public class CompanyFeatureFlagsProviderImpl
	implements CompanyFeatureFlagsProvider {
	...
	private CompanyFeatureFlags _createCompanyFeatureFlags(long companyId) {
		try (SafeCloseable safeCloseable =
			...
			return new CompanyFeatureFlagsImpl(
				Collections.unmodifiableMap(featureFlagsMap));
		}
	}

	private static final Log _log = LogFactoryUtil.getLog(
		CompanyFeatureFlagsProviderImpl.class);
	...
	private static final MethodKey _setEnabledMethodKey = new MethodKey(
		CompanyFeatureFlagsProviderImpl.class, "_setEnabled", long.class,
