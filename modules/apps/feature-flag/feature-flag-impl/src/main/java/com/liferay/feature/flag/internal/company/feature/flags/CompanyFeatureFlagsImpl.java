...
import com.liferay.feature.flag.model.FeatureFlagWrapper;
 ...
 * @author Drew Brokke
 */
public class CompanyFeatureFlagsImpl implements CompanyFeatureFlags {

	public CompanyFeatureFlagsImpl(Map<String, FeatureFlag> featureFlagsMap) {
